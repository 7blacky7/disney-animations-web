...
const MOCK_DEPARTMENTS: Department[] = [
  { id: "1", name: "IT", memberCount: 12, quizCount: 5, leadName: "Anna Schmidt" },
  { id: "2", name: "Marketing", memberCount: 8, quizCount: 3, leadName: "Max Mueller" },
  { id: "3", name: "Vertrieb", memberCount: 15, quizCount: 7, leadName: null },
  { id: "4", name: "Personal", memberCount: 4, quizCount: 2, leadName: null },
];
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            {MOCK_DEPARTMENTS.length} Abteilungen in Ihrer Organisation.
          </p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        {MOCK_DEPARTMENTS.map((dept, i) => (
          ...
          >
            ...
            {dept.leadName && (
              <p className="mt-0.5 text-xs text-muted-foreground">Leitung: {dept.leadName}</p>
            )}
            <div className="mt-4 flex gap-4">
              <div>
                <p className="font-heading text-xl font-bold">{dept.memberCount}</p>
                <p className="text-[10px] text-muted-foreground">Mitglieder</p>
              </div>
              <div>
                <p className="font-heading text-xl font-bold">{dept.quizCount}</p>
          ...
          <>
            ...
            >
              ...
              <div className="mt-6 flex justify-end gap-2">
                ...
                <AnimatedButton shine size="sm" onClick={() => setShowCreate(false)}>Erstellen</AnimatedButton>
              </div>
            </motion.div>
          </>
        )}
